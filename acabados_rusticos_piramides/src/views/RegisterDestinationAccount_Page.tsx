...
export default function RegisterDestinationAccount_Page() {
  ...
  const [accounts, setAccounts] = useState<Account[]>([
    { id: '1', alias: 'Negocio1', nombre: 'Juan Perez', banco: 'BBVA', cuenta: '1234567890', clabe: '012345678901234567' },
    { id: '2', alias: 'Negocio2', nombre: 'Karla', banco: 'Banamex', cuenta: '123487854658', clabe: '888 999 77' },
  ]);
  ...
  const filteredAccounts = accounts.filter(acc => 
    ...
    acc.banco.toLowerCase().includes(searchQuery.toLowerCase()) ||
    acc.cuenta.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.alias || !formData.nombre) return;
    ...
    setFormData({ alias: '', nombre: '', banco: '', cuenta: '', clabe: '' });
                  ...
                  <div className="flex-1 bg-white rounded shadow-sm overflow-hidden border border-gray-200">
                    ...
                    <button 
                      ...
                      className={`w-full flex items-center justify-between px-4 py-2.5 text-sm font-medium transition-colors ${
                        expandedAccountId === acc.id ? 'bg-[#16A085] text-white' : 'bg-white text-gray-800 hover:bg-gray-50'
                      }`}
                    >
        ...
        <div className="flex-1 flex flex-col pt-10 px-0 lg:px-8">
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-xl mx-auto w-full">
            ...
            <div className="flex items-center justify-between">
              <label htmlFor="alias" className="text-gray-900 font-medium w-1/3 text-sm">
                Alias de cuenta:
              </label>
              <input 
                type="text" 
            ...
            <div className="flex items-center justify-between">
              <label htmlFor="nombre" className="text-gray-900 font-medium w-1/3 text-sm">
                Nombre titular:
              </label>
              <input 
                type="text" 
            ...
            <div className="flex items-center justify-between">
              <label htmlFor="banco" className="text-gray-900 font-medium w-1/3 text-sm">
                Banco:
              </label>
              <input 
                type="text" 
            ...
            <div className="flex items-center justify-between">
              <label htmlFor="cuenta" className="text-gray-900 font-medium w-1/3 text-sm">
                Número Cuenta:
              </label>
              <input 
                type="text" 
